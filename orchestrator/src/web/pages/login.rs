                ...
                <div class="flex items-center justify-center min-h-screen">
                    <form method="POST" action="/login" class="w-[400px] rounded-xl bg-[#16161E] border border-[#27272A] px-10 pt-12 pb-10 flex flex-col gap-7">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-[#71717A] text-sm">"Sign in to your account"</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <div class="flex gap-1">
                                <span class="text-[#71717A] text-[13px]">"New here?"</span>
                                <a href="/signup" class="text-indigo-500 text-[13px] font-medium hover:underline">
                                    "Sign up →"
                                </a>
                            </div>
                        </div>
